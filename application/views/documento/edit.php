    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Documento Edit</h3>
            </div>
			...
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="tipo" class="form-control">
								...
								{
									$selected = ($value == $documento['tipo']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="proveedor_cuenta_id1" class="form-control">
								...
								{
									$selected = ($proveedor_cuentum['id'] == $documento['proveedor_cuenta_id1']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="codigo" value="<?php echo ($this->input->post('codigo') ? $this->input->post('codigo') : $documento['codigo']); ?>" class="form-control" id="codigo" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="monto_neto" value="<?php echo ($this->input->post('monto_neto') ? $this->input->post('monto_neto') : $documento['monto_neto']); ?>" class="form-control" id="monto_neto" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="monto_total" class="control-label">Monto Total</label>
						<div class="form-group">
							<input type="text" name="monto_total" value="<?php echo ($this->input->post('monto_total') ? $this->input->post('monto_total') : $documento['monto_total']); ?>" class="form-control" id="monto_total" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="fecha_carga" class="control-label">Fecha Carga</label>
						<div class="form-group">
							<input type="text" name="fecha_carga" value="<?php echo ($this->input->post('fecha_carga') ? $this->input->post('fecha_carga') : $documento['fecha_carga']); ?>" class="has-datetimepicker form-control" id="fecha_carga" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="fecha_modif" class="control-label">Fecha Modif</label>
						<div class="form-group">
							<input type="text" name="fecha_modif" value="<?php echo ($this->input->post('fecha_modif') ? $this->input->post('fecha_modif') : $documento['fecha_modif']); ?>" class="has-datetimepicker form-control" id="fecha_modif" />
						</div>
					</div>
				</div>
			</div>
