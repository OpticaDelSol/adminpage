    ...
    <head>
        ...
        <style>
            ...
            .label-info, .modal-info .modal-body {
                background-color: #3556B8!important;
            }
            body{
                color: #002166;
...
<!--                    <div class="col-md-12">
                            <div class="alert alert-info alert-dismissible">
                                <button class="btn btn-default" id="autofill_btn">Autocompletar</button>
                            </div>
                    </div>-->
                    <?php                    
            ...
            <footer class="main-footer">
                <strong>OPTICA DEL SOL 2022</strong>
            </footer>
        ...
        <script src="<?php echo site_url('resources/js/autocompletar.js');?>"></script>
        ...
        <?php }}?>
            ...
            $('.monthpicker').each( function() { $(this).datetimepicker({locale:'es',format:'MM/Y'}); } );
