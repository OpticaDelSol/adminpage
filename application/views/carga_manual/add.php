    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Carga Manual Add</h3>
            </div>
            <?php echo form_open('carga_manual/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="proveedor_cuenta_id" class="form-control">
								...
								{
									$selected = ($proveedor_cuentum['id'] == $this->input->post('proveedor_cuenta_id')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="comentario" value="<?php echo $this->input->post('comentario'); ?>" class="form-control" id="comentario" />
						</div>
					</div>
				</div>
			</div>
