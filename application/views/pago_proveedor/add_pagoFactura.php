   ...
   <div class="col-md-12">
    ...
    <div class="col-md-12">
      	<div class="box box-info">
            ...
            echo form_open('pago_proveedor/add_pagoFactura/'.$id_proveedor,$attributes); 
            ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-3">
						...
						<div class="input-group">
                                                    ...
                                                    <input readonly="true" type="number" step=".01"
                                                               name="monto" value="<?php echo $this->input->post('monto'); ?>" class="form-control  monto-type monto-total" id="monto" style="text-align: right;" />
