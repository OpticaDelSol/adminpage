			...
			<div class="box-body">
				<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="permisos" value="<?php echo ($this->input->post('permisos') ? $this->input->post('permisos') : $usuario['permisos']); ?>" class="form-control" id="permisos" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="fecha_alta" value="<?php echo ($this->input->post('fecha_alta') ? $this->input->post('fecha_alta') : $usuario['fecha_alta']); ?>" class="has-datetimepicker form-control" id="fecha_alta" />
						</div>
					</div>
				</div>
			</div>
