    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Documento Iva Edit</h3>
            </div>
			<?php echo form_open('documento_iva/edit/'.$documento_iva['id']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="documento_id" class="form-control">
								...
								{
									$selected = ($documento['id'] == $documento_iva['documento_id']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="monto" value="<?php echo ($this->input->post('monto') ? $this->input->post('monto') : $documento_iva['monto']); ?>" class="form-control" id="monto" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="porcentaje" value="<?php echo ($this->input->post('porcentaje') ? $this->input->post('porcentaje') : $documento_iva['porcentaje']); ?>" class="form-control" id="porcentaje" />
